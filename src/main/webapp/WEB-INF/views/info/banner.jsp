...
<!-- <div class="header_list">
				...
				<div class="drop-down">
					<a class="first-drop-btn" href="/board/boardList">게시판</a>
				</div>
				<div class="dropdown-content">
					<a href="#">에니어그램이란</a> 
					<a href="#">9가지의 유형</a> 
