...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets3/css/main.css" />
...
<div id="main">
	...
	<div class="inner">
		<header>
			<h1 style="padding: 0; margin: 10px;">
				에니어그램 9가지의 유형입니다
			</h1>
	...
	<script src="${pageContext.request.contextPath}/resources/assets3/js/skel.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/assets3/js/util.js"></script>
	<!--[if lte IE 8]><script src="assets/js/ie/respond.min.js"></script><![endif]-->
	<script src="${pageContext.request.contextPath}/resources/assets3/js/main.js"></script> 
