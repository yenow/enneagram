...
<form action="member_insert_ok" method="post" id="member-insert" onsubmit="return check();" > 
	<table>
		<caption>회원가입 양식</caption>
		<tr>
			<td>아이디</td> <td><input type="text" name="user_id" class="user_id"></td>
		</tr>
		<tr>
			<td>비밀번호</td> <td><input type="password" name="user_pw" class="user_pw"></td>
		</tr>
		<tr>
		...
		<tr>
			<td>번호</td> <td><input type="tel" name="tel" class="tel"></td>
		</tr>
		<tr>
			<td>이메일</td> <td><input type="email" name="email"></td>
		</tr>
		<tr>
			<td>주소</td> <td><input type="text" name="address" class="address"></td>
		</tr>
		<tr>
