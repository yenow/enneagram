			...
			<div class="login-box col-md-5 text-center">
				<form action="${pageContext.request.contextPath}/member/login_ok" method="post">
					...
					<p>
						...
						<label class="float-left" for="log-check"> <span></span> 로그인 상태 유지</label>
					</p>
					<div class="comment-form-wrap"></div>
					<p ><a href="#" class="float-left">아이디찾기</a> <a href="#" class="float-left ml-2" >비밀번호찾기</a> <a href="#" class="float-right">회원가입</a></p>
					<div class="comment-form-wrap"></div>
