<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- Scripts -->
	<script src="${pageContext.request.contextPath}/resources/assets2/js/jquery.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/assets2/js/browser.min.js"></script>
